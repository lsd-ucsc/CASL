...
* lindsey: as gan pointed out, it's nice that as Gan pointed out this paper is
  open access; they're published in PACMPL; all of the big four ACM conferences
  are in PACMPL except for PLDI
...
* lindsey: big picture
    ...
    * lindsey: this paper makes the point that some compositions don't work
      ...
      an operation would colfict with the Map's add operation [if you don't add
...
* lindsey: the idea is
    ...
    * lindsey: in 6.1 they introduce OT; the classic example is "insert at
      index 3 to list" an concurrently "insert at index 1 to list" where the
